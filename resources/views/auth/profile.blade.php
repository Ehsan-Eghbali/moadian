...
@section('content')
    <div class="row">
        <div class="col-md-3">
            <form id="update" action="{{route('profile.update')}}" method="post" enctype="multipart/form-data">
                @method('PATCH')
            @csrf
            ...
            <div class="card card-primary card-outline">
                <div class="card-body box-profile">
                    <div class="profile-pic">
                        ...
                        <img id="output"  src="@if(count($auth->attachment)>0) {{$auth->attachment[0]->path}} @else /assets/admin/images/user.svg @endif" class="profile-user-img img-fluid img-circle">
                    </div>

                    <h3 class="profile-username text-center">{{$auth->name . ' ' . $auth->family}}</h3>
                    <p class="text-muted text-center">{{$auth->user}}</p>
            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    ...
                    <p class="text-muted">{{implode(',',$auth->roll->pluck('name')->toArray())}}</p>
                    <hr>
                            ...
                            <div class="card-body">
                                <form action="{{route('profile.update')}}" method="post">
                                    ...
                                    <div class="input-group mb-3">
                                        <input name="currentPassword" type="password" class="form-control" placeholder="رمز عبور فعلی">
